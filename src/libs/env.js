...
export const { DB_HOST, DB_PORT, JWT_SECRET, DB_USERNAME, DB_PASSWORD, FRONTEND_URL, EMAIL_ADDRESS, EMAIL_PASSWORD, CLOUDINARY_API_KEY, CLOUDINARY_CLOUD_NAME, CLOUDINARY_API_SECRET } = /** @type {Record<string, string>} */ (process.env);
